// $Id: main.cpp,v 1.28 2014/02/25 21:43:13 david Exp $ -*- c++ -*-
#include <iostream>
#include <memory>
#include <string>
...
inline static void process_options(int argc, char *argv[],
...
inline static std::string language_name(const std::string &name) {
